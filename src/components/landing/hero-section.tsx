  ...
  return (
    <section className="relative pt-32 sm:pt-40 pb-20 sm:pb-28 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Stop chasing debts across WhatsApp threads and notebooks. CredFlow gives
          you one dashboard for customer debts, payments, and cash flow — so you
              ...
              <div className="flex min-h-110 sm:min-h-130">
                ...
                <div className="flex-1 p-4 sm:p-6 flex flex-col gap-4 sm:gap-5">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { label: 'Outstanding', value: '₦2.4M', trend: '+8%', color: 'text-foreground' },
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 flex-1">
                    ...
                    <div className="sm:col-span-2 rounded-lg border border-border/60 bg-background/60 p-3">
                      ...
                      <div className="space-y-2">
                        {[
                          { name: 'Chinedu Okafor', amt: '₦45K', status: '5d late' },
                          { name: 'Adaeze Nwosu', amt: '₦120K', status: '2d late' },
                          { name: 'Tunde Adeyemi', amt: '₦8.2K', status: 'Due today' },
                        ].map((r, i) => (
