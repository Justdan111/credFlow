      ...
      <div className="hidden lg:flex flex-col justify-between p-8 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <h2 className="text-4xl font-bold text-white leading-tight">
            Manage Your Business Debts with Confidence
          </h2>
          <p className="text-purple-100 text-lg">
            Track, organize, and collect customer debts efficiently. Built for African SMEs.
          </p>
        </div>

        <div className="relative z-10 flex items-center gap-4 text-purple-100">
        ...
        <div className="w-full max-w-md animate-fadeInUp">
          ...
          <div className="space-y-8">
            <div className="space-y-2 text-center lg:text-left">
              ...
              <p className="text-foreground/60">Sign in to your CredFlow account</p>
            </div>
